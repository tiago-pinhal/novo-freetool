...
<i18n lang="yaml">
{
    ...
    pt: {
        title: "Ferramentas de Dados Aleatórios",
    ...
    es: {
        title: "Herramientas de Datos Aleatorios",
    ...
    fr: {
        title: "Outils de Données Aléatoires",
    ...
    it: {
        title: "Strumenti di Dati Casuali",
