...
<i18n lang="yaml">
{
  ...
  de: {
    pageTitle: "Gültiger RG-Generator Online für Tests — Kostenlos",
    title: "Brasilianischer RG-Generator",
    meta: "Zufälliger RG-Nummern-Generator für Softwaretests und Demonstrationen. Erstellen Sie fiktive Nummern im Standardformat, sicher und ohne echte Daten.",
    d1: "Das Registro Geral (RG) ist das wichtigste zivile Identitätsdokument in Brasilien und dient dazu, die Identität einer Person in verschiedenen Alltagssituationen wie der Eröffnung von Bankkonten, Schulanmeldungen, Verträgen und anderen Rechtsgeschäften nachzuweisen",
    d2: "Unser Zufalls-RG-Nummern-Generator wurde entwickelt, um die Erstellung fiktiver RG-Nummern zu erleichtern, ideal für Softwaretests, Systemdemonstrationen und Entwicklungsumgebungen. Dieses Tool wird besonders für Entwickler, Softwaretester und Technologieexperten empfohlen, die Prozesse validieren müssen, ohne echte persönliche Daten zu verwenden",
    d3: "Das Tool generiert zufällige RG-Nummern, die keine Verbindung zu echten Identifikationsdaten haben, was Privatsphäre und Sicherheit während der Tests gewährleistet. Die Nummern folgen dem brasilianischen Standard-RG-Format, zum Beispiel „99.999.999-9“. Für mehr Flexibilität kann die Option „Nur Zahlen“ gewählt werden, die die RG ohne Punkte oder Bindestriche generiert, was die Eingabe in Datenbanken oder Systeme erleichtert, die ein reines numerisches Format erfordern",
    d4: "Es ist wichtig zu betonen, dass die Fälschung von RGs eine gesetzlich strafbare Handlung ist und der Missbrauch der von diesem Tool generierten Informationen schwerwiegende rechtliche Konsequenzen haben kann. Daher ist die Nutzung des Generators ausschließlich für Bildungszwecke, Softwaretests und legitime Demonstrationen bestimmt, wobei der Benutzer die volle Verantwortung für die korrekte Verwendung der generierten Daten übernimmt",
    num: "Nur Zahlen",
    bt: "RG generieren",
    placeholder: "Klicken Sie auf RG generieren, um eine Nummer zu erstellen",
    rg_label: "Generierte RG",
    warning: "Die generierten Nummern sind fiktiv und ausschließlich für Testzwecke bestimmt.",
    br: "Brasilien",
    how_to_use_title: "Anleitung",
    step_1_title: "Eine RG generieren",
    step_1_desc: "Wählen Sie das gewünschte Format und klicken Sie auf „RG generieren“. Die generierte Nummer kann mit einem Klick in die Zwischenablage kopiert werden.",
    step_2_title: "Mit oder ohne Zeichen",
    step_2_desc: "Aktivieren Sie „Nur Zahlen“, um die RG ohne Punkte und Bindestrich zu erhalten — ideal für Integrationen und Datenbanken.",
    step_3_title: "Ergebnis kopieren",
    step_3_desc: "Die generierte RG erscheint sofort. Verwenden Sie die Kopier-Schaltfläche, um sie in die Zwischenablage zu senden.",
    see1: "CPF-Generator",
    see2: "CNPJ-Generator",
  ...
  nl: {
    pageTitle: "Geldige RG-generator online voor tests — Gratis",
    title: "Braziliaanse RG-generator",
    meta: "Willekeurige RG-nummergenerator voor softwaretests en demonstraties. Maak fictieve nummers in het standaardformaat, veilig en zonder echte gegevens.",
    d1: "Het Registro Geral (RG) is het belangrijkste civiele identificatiedocument in Brazilië, dat wordt gebruikt om de identiteit van een persoon te bewijzen in verschillende alledaagse situaties, zoals het openen van bankrekeningen, schoolinschrijvingen, contracten en andere juridische transacties",
    d2: "Onze willekeurige RG-nummergenerator is ontwikkeld om het maken van fictieve RG-nummers te vergelijken, ideaal voor softwaretests, systeemdemonstraties en ontwikkelomgevingen. Deze tool wordt speciaal aanbevolen voor ontwikkelaars, softwaretesters en technologieprofessionals die processen moeten valideren zonder echte persoonlijke gegevens te gebruiken",
    d3: "De tool genereert willekeurige RG-nummers die geen verband houden met echte identificatiegegevens, wat de privacy en veiligheid tijdens het testen garandeert. De nummers volgen het Braziliaanse standaard RG-formaat, bijvoorbeeld “99.999.999-9”. Voor meer flexibiliteit is het mogelijk om de optie “Alleen cijfers” te selecteren, die de RG genereert zonder punten of streepjes, waardoor deze gemakkelijker kan worden ingevoerd in databases of systemen die een puur numeriek formaat vereisen",
    d4: "Het is belangrijk om te benadrukken dat RG-vervalsing een strafbaar feit is en dat misbruik van de informatie die door deze tool wordt gegenereerd, ernstige juridische gevolgen kan hebben. Daarom is het gebruik van de generator strikt exclusief voor educatieve doeleinden, softwaretests en legitieme demonstraties, waarbij de gebruiker de volledige verantwoordelijkheid op zich neemt voor het correcte gebruik van de gegenereerde gegevens",
    num: "Alleen cijfers",
    bt: "RG genereren",
    placeholder: "Klik op RG genereren om een nummer te maken",
    rg_label: "Gegenereerde RG",
    warning: "De gegenereerde nummers zijn fictief en uitsluitend bedoeld voor testdoeleinden.",
    br: "Brazilië",
    how_to_use_title: "Hoe te gebruiken",
    step_1_title: "Genereer een RG" ,
    step_1_desc: "Kies het gewenste formaat en klik op \"RG genereren\". Het gegenereerde nummer kan met één klik naar uw klembord worden gekopieerd.",
    step_2_title: "Met of zonder leestekens",
    step_2_desc: "Schakel \"Alleen cijfers\" in om de RG zonder punten en streepje te krijgen — ideaal voor integraties en databases.",
    step_3_title: "Resultaat kopiëren",
    step_3_desc: "De gegenereerde RG verschijnt direct. Gebruik de kopieerknop om deze naar uw klembord te sturen.",
    see1: "CPF-generator",
    see2: "CNPJ-generator",
    see3: "Creditcardgenerator",
