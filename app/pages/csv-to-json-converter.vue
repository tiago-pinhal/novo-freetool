...
<i18n lang="yaml">
{
  ...
  fr: {
    ...
    see1: "Visionneuse JSON",
    see2: "Convertisseur XML en JSON",
    see3: "Convertisseur JSON en XML",
    see4: "Formateur JSON",
  ...
  it: {
    ...
    see3: "Convertitore JSON in XML",
    see4: "Formattatore JSON",
