...
<i18n lang="yaml">
{
  ...
  es: {
    ...
    sale_price: "El precio de venta es:",
  ...
  fr: {
    ...
    value: "La valeur",
    rep: "Représente",
    rep_of: "Est quel pourcentage de",
    ...
    sale_price: "Le prix de vente est:",
  ...
  it: {
    ...
    sale_price: "Il prezzo di vendita è:",
  ...
  id: {
    ...
    value: "Nilai",
    rep: "Mewakili",
    rep_of: "Adalah berapa persen dari",
    ...
    sale_price: "Harga jualnya adalah:",
