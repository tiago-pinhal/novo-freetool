  ...
  >
    ...
    <div v-if="state.result" class="space-y-4">
      ...
      <div>
        ...
        <div class="stats shadow w-full border border-base-content/10">
          <div class="stat">
